...
class _EventDetailsState extends State<EventDetails> {
  ...
  String formatDateTimeRange(String dateTimeStr) {
    final inputFormat = DateFormat("yyyy-MM-dd'T'HH:mm:ss");
    final outputDayFormat = DateFormat.EEEE();
    final outputTimeFormat = DateFormat.jm();
    final dateTime = inputFormat.parse(dateTimeStr, true);
          ...
          child: Column(
            ...
            Column(
              ...
              Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.only(top: 20.0,right: 235,bottom: 0),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (widget.description.split(' ').length > 20 && !isExpanded)
                            Text(
                              'Read more...',
                              style: TextStyle(
                                fontSize: 16,
